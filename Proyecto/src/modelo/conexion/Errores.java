...
public class Errores {
    public static String MessageError(int errorcode,String sqlexception){
        ...
        switch(errorcode){
            ...
            case 1111 :    
                errornombre=" Invalido uso de funciÃ³n en grupo";break;
            case 1113 :
                errornombre="Una tabla debe tener al menos 1 columna";break;
            case 1114 :    
                errornombre="La tabla '%s' estÃ¡ llena ";break;
            case 1115 :
            ...
            case 1118 :    
                errornombre="TamaÃ±o de lÃ­nea muy grande. MÃ¡ximo tamaÃ±o de lÃ­nea, no contando blob, es %ld. Tu tienes que cambiar algunos campos para blob";break;
            case 1120 :
                errornombre="Dependencia cruzada encontrada en OUTER JOIN. Examine su condiciÃ³n ON";break;
            case 1122 :    
                errornombre=" No puedo cargar funciÃ³n";break;
            case 1123 :
                errornombre="No puedo inicializar funciÃ³n ";break;
            case 1124 :    
                errornombre="No pasos permitidos para librarias conjugadas";  break;
            case 1127 :
                errornombre="No puedo encontrar funciÃ³n";break;
            case 1128 :    
                errornombre="FunciÃ³n '%s' no estÃ¡ definida";break;
            case 1129 :
                errornombre="Servidor '%s' estÃ¡ bloqueado por muchos errores de conexiÃ³n. Desbloquear con 'mysqladmin flush-hosts'";break;
            case 1131 :    
                errornombre="Tu estÃ¡s usando MySQL como un usuario anonimo y usuarios anonimos no tienen permiso para cambiar las claves";break;
            case 1132 :
            ...
            case 1133 :    
                errornombre="No puedo encontrar una lÃ­nea correspondiente en la tabla user ";break;
            case 1135 :
                errornombre="No puedo crear un nuevo thread (errno %d). Si tu estÃ¡ con falta de memoria disponible, tu puedes consultar el Manual para posibles problemas con SO";break;
            case 1138 :    
            ...
            case 1148 :    
                errornombre="El comando usado no es permitido con esta versiÃ³n de MySQL";break;
            case 1149 :
                errornombre=" Algo estÃ¡ equivocado en su sintax ";  break;
            case 1157 :    
                errornombre="No puedo descomprimir paquetes de comunicaciÃ³n";break;
            case 1158 :
                errornombre="Obtenido un error leyendo paquetes de comunicaciÃ³n";break;
            case 1159 :    
                errornombre="Obtenido timeout leyendo paquetes de comunicaciÃ³n ";break;
            case 1160 :
                errornombre="Obtenido un error de escribiendo paquetes de comunicaciÃ³n";break;
            case 1161 :    
                errornombre="Obtenido timeout escribiendo paquetes de comunicaciÃ³n";  break;
            case 1163 :
            ...
            case 1169 :
                errornombre="No puedo escribir, debido al Ãºnico constraint, para tabla";break;
            case 1171 :    
                errornombre="Todas las partes de un PRIMARY KEY deben ser NOT NULL; Si necesitas NULL en una clave, use UNIQUE ";break;
            case 1172 :
                errornombre="Resultado compuesto de mas que una lÃ­nea ";break;
            case 1173 :    
                errornombre="Este tipo de tabla necesita de una primary key";break;
            case 1175 :
                errornombre="Tu estÃ¡s usando modo de actualizaciÃ³n segura intentado actualizar una tabla sin un WHERE que usa una KEY columna";break;
            case 1177 :    
            ...
            case 1191 :
                errornombre="No puedo encontrar Ã­ndice FULLTEXT correspondiendo a la lista de columnas";break;
            case 1204 :
            ...
            case 1206 :
                errornombre="El nÃºmero total de bloqueos excede el tamaÃ±o de bloqueo de la tabla ";break;
            case 1210 :    
                errornombre="Argumentos errados";break;
            case 1214 :
                errornombre="El tipo de tabla usada no soporta Ã­ndices FULLTEXT";  break;
            case 1215 :    
                errornombre="No puede adicionar clave extranjera constraint";break;
            case 1222 :
                errornombre="El comando SELECT usado tiene diferente nÃºmero de columnas";break;
            case 1223 :    
            ...
            case 1235 :    
                errornombre="Esta versiÃ³n de MySQL no soporta todavia";  break;
            case 1240 :
                errornombre="Referencia de llave y referencia de tabla no coinciden";break;
            case 1242 :    
                errornombre="Subconsulta retorna mas que 1 lÃ­nea";break;
            case 1245 :
                errornombre="CÃ­clica referencia en subconsultas";break;
            case 1248 :    
                errornombre="Cada tabla derivada debe tener su propio alias";break;
            case 1251 :
                errornombre="Cliente no soporta protocolo de autenticaciÃ³n solicitado por el servidor; considere actualizar el cliente MySQL";break;
            case 1317 :    
            ...
            case 2002 :    
                errornombre="No puede conectarse al servidor local MySQL a travÃ©s de conector ";break;
            case 2003 :
                errornombre="No puede conectarse al servidor MySQL en ";break;
            case 2008 :    
                errornombre="El cliente MySQL se quedÃ³ sin memoria";break;
            case 2050 :
                errornombre=" La fila que la recuperaciÃ³n fue cancelada por la llamada _ cercana mysql stmt ()";break;
            case 2052 :    
                errornombre="La declaraciÃ³n preparada no contiene metadatos";break;
            default :
